...
func BindDataSourceWithClass[T TableBase[T]](db *sql.DB, dbtype DBType) {
	dbContainer.putTables(newdbhandle(db, dbtype), Classname[T]())
}
...
func UnbindDataSourceWithClass[T TableBase[T]]() {
	dbContainer.delTables(Classname[T]())
}
